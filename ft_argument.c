...
/*   Updated: 2018/02/22 20:34:49 by mpascaud         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_argument(va_list args, t_variables *variables)
{
	...
	if (variables->specificateur == 'o' || variables->specificateur == 'O' || variables->specificateur == 'u' || variables->specificateur == 'U' || variables->specificateur == 'x' || variables->specificateur == 'X')
